...
Six rules. Five parties. One structural argument: governance distributed across five forces is more stable, more representative, and more resilient than a two-party binary.
...
- **Bonus seats** — reverse-size allocation that compresses the gap between large and small parties, inverting the usual proportional system bias toward bigger parties
